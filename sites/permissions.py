...
def site_role_required(*allowed_roles):
...
site_staff_required = site_role_required(
    SiteRole.Role.SUBSCRIBER_ADMIN, SiteRole.Role.SITE_MANAGER
)
subscriber_admin_required = site_role_required(SiteRole.Role.SUBSCRIBER_ADMIN)
